                    ...
                    <ul class="accordion">
                        <li>
                            <input
                                ...
                                id="first"
                            />
                            <label for="first"><h3>Maths</h3></label>
                            <div class="content">
                                <a href="https://www.youtube.com/playlist?list=PLed4Ta-AnBbNGXjtMDAV8YVE_WW8i-v9M"
                    ...
                    <ul class="accordion">
                        <li>
                            <input
                                ...
                                id="second"
                            />
                            <label for="second"><h3>Physics</h3></label>
                            <div class="content">
                                <a href="https://www.youtube.com/playlist?list=PLed4Ta-AnBbPlwPyvLrdWx_ytZO4bPhbv"
                                    ><div id="content-names">Assignments</div></a
                                >
